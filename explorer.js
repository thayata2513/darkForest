...
import { html, render, useEffect, useState,
//@ts-ignore
 } from 'https://unpkg.com/htm/preact/standalone.module.js';
const { MinerManager: Miner, SwissCheesePattern, SpiralPattern, TowardsCenterPattern, TowardsCenterPatternV2, } = df.getConstructors();
    ...
    class RemoteWorker {
        ...
        async postMessage(msg) {
            ...
            for (const planetLoc of exploredChunk.planetLocations) {
                ...
                planetLoc.biomebase = df.biomebasePerlin({ x: planetLoc.coords.x, y: planetLoc.coords.y }, true);
            }
...
function MinerUI({ miner, onRemove, }) {
    ...
    useEffect(() => {
        const calcHash = (chunk, miningTimeMillis) => {
            ...
            if (res) {
                ...
                (_b = ui === null || ui === void 0 ? void 0 : ui.setExtraMinerLocation) === null || _b === void 0 ? void 0 : _b.call(ui, miner.id, {
                    x: bottomLeft.x + sideLength / 2,
                    y: bottomLeft.y + sideLength / 2,
                });
            }
            else {
                (_c = ui === null || ui === void 0 ? void 0 : ui.removeExtraMinerLocation) === null || _c === void 0 ? void 0 : _c.call(ui, miner.id);
            }
        };
    ...
    useEffect(() => {
        const hover = () => {
            ...
            if (coords) {
                (_b = ui === null || ui === void 0 ? void 0 : ui.setExtraMinerLocation) === null || _b === void 0 ? void 0 : _b.call(ui, miner.id, coords);
            }
        };
        const click = () => {
...
class RemoteExplorerPlugin {
    constructor() {
        this.addMiner = (url, patternType = 'spiral', chunkSize = 1024) => {
            // TODO: Somehow set a default coords
            const pattern = getPattern({ x: 0, y: 0 }, patternType, chunkSize);
            const miner = Miner.create(df.getChunkStore(), pattern, df.getWorldRadius(), df.planetRarity, df.getHashConfig(), false, workerFactory(url));
            miner.url = url;
            miner.id = this.id++;
        ...
        this.removeMiner = (miner) => {
            this.miners = this.miners.filter((m) => {
                var _b;
                if (m === miner) {
                    (_b = ui === null || ui === void 0 ? void 0 : ui.removeExtraMinerLocation) === null || _b === void 0 ? void 0 : _b.call(ui, m.id);
                    m.stopExplore();
                    m.destroy();
                    return false;
                }
    ...
    destroy() {
        ...
        for (const miner of this.miners) {
            (_b = ui === null || ui === void 0 ? void 0 : ui.removeExtraMinerLocation) === null || _b === void 0 ? void 0 : _b.call(ui, miner.id);
            miner.stopExplore();
            miner.destroy();
        }
    }
